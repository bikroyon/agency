...
const portfolioSections = [
  ...
  {
    key: "social",
    title: t("portfolio_page.sections.social.title"),
    description: t("portfolio_page.sections.social.description"),
    items: [
      {
        image: "https://picsum.photos/800/600?random=5",
        title: t("portfolio_page.sections.social.items.0.title"),
        desc: t("portfolio_page.sections.social.items.0.desc"),
        btn: t("portfolio_page.sections.social.items.0.btn"),
        url: "https://example.com",
      },
      {
        image: "https://picsum.photos/800/600?random=6",
        title: t("portfolio_page.sections.social.items.1.title"),
        desc: t("portfolio_page.sections.social.items.1.desc"),
        btn: t("portfolio_page.sections.social.items.1.btn"),
        url: "https://example.com",
      },
    ],
  },
