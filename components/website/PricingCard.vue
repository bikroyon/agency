...
<template>
  <div class="relative">
    ...
    >
      ...
      >
        {{ t("ecommerce_page.pricing.recomended") }}
      </div>
    </div>
    <div
      :class="[
    ...
    >
      <div class="mb-5">
        ...
        >
          ...
          <span> {{ t("ecommerce_page.pricing.cta_button") }} </span>
        </NuxtLink>
      </div>
